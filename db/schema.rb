...
ActiveRecord::Schema[7.0].define(version: 2024_03_26_090539) do
  ...
  create_table "measurements", force: :cascade do |t|
    ...
    t.integer "min_heart_rate_limit"
    t.integer "max_heart_rate_limit"
    t.float "artefact_rate"
    t.integer "noise_count"
    t.integer "qrs_count"
  end
